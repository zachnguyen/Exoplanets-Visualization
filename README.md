...
* Note: Some of the axis are in log scale. Click the tab name up to to switch tabs, click on the legend to hide the exoplanet data and see only the solar system planets.
...
- The third graph describes an interesting quality of planets, their eccentricity. Simply put, the more eccentric a planet is, the more eliptical its orbit, causing extreme seasonable patterns (scorching for a few days, then freezing for most of the year).  
